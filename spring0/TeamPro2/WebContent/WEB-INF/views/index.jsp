		...
		<div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<div class="card-deck">
				...
				<div class="card">
					<img src="<c:url value="/images/긴자바이린.jpg"/>" class="card-img-top"
						alt="...">
					<div class="card-body">
						<a href="/TeamPro2/pork/gindon.jsp" class="card-title">긴자바이린</a>
				...
				<div class="card">
					<img src="<c:url value="/images/독립카츠.jpg"/>" class="card-img-top"
						alt="...">
					<div class="card-body">
						<a href="/TeamPro2/pork/doklipdon.jsp" class="card-title">독립카츠</a>
					</div>
					<div class="card-footer">
						<small class="text-muted">Last updated 3 mins ago</small>
					</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<a href="/TeamPro2/pork/daddon.jsp" class="card-title">아빠곰 수제돈까스</a>
					</div>
					<div class="card-footer">
						<small class="text-muted">Last updated 3 mins ago</small>
					</div>
			...
			<div class="card-deck">
				<div class="card">
					...
					<img src="<c:url value="/images/안즈.jpg"/>" class="card-img-top"
						alt="">
					<div class="card-body">
						<a href="/TeamPro2/pork/anzdon.jsp" class="card-title">안즈</a>
					</div>
					<div class="card-footer">
						<small class="text-muted">Last updated 3 mins ago</small>
					</div>
				...
				<div class="card">
					<img src="<c:url value="/images/정돈.jpg"/>" class="card-img-top"
						alt="...">
					<div class="card-body">
						<a href="/TeamPro2/pork/jung.jsp" class="card-title">정돈</a>
					</div>
					<div class="card-footer">
						<small class="text-muted">Last updated 3 mins ago</small>
					</div>
				...
				<div class="card">
					<img src="<c:url value="/images/즐거운 맛 돈까스.jpg"/>" class="card-img-top"
						alt="...">
					<div class="card-body">
						<a href="/TeamPro2/pork/KINdon.jsp" class="card-title">즐거운 맛 돈까스</a>
					</div>
					<div class="card-footer">
						<small class="text-muted">Last updated 3 mins ago</small>
					</div>
			...
			<div class="card">
				<img src=<c:url value="/images/카츠진.jpg"/> class="card-img-top"
					alt="">
				<div class="card-body">
					<a href="/TeamPro2/pork/kazdon.jsp" class="card-title">카츠진</a>
				</div>
				<div class="card-footer">
					<small class="text-muted">Last updated 3 mins ago</small>
				</div>
			...
			<div class="card">
				<img src="<c:url value="/images/크레이지카츠.jpg"/>" class="card-img-top"
					alt="...">
				<div class="card-body">
					<a href="/TeamPro2/pork/crazydon.jsp" class="card-title">크레이지 카츠</a>
				</div>
				<div class="card-footer">
					<small class="text-muted">Last updated 3 mins ago</small>
				</div>
			...
			<div class="card">
				<img src="<c:url value="/images/삼백돈 돈가츠.jpg"/>" class="card-img-top"
					alt="...">
				<div class="card-body">
					<a href="/TeamPro2/pork/300don.jsp" class="card-title">삼백돈</a>
				</div>
				<div class="card-footer">
					<small class="text-muted">Last updated 3 mins ago</small>
				</div>
