...
<body>
	...
	<main role="main" class="container">
		<div
			...
			<div class="lh-100">
				<h3 class="mb-0 text-white lh-100">키워드로 맛집 검색</h3>
				<h6>ex)강남 맛집, 돈까스 맛집</h6>
			</div>
		</div>

		<div class="my-3 p-3 bg-white rounded box-shadow">
			<h6 class="border-bottom border-gray pb-2 mb-0">맛집 검색하기</h6>
			...
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=18485baa10e48dfbbb969adf5c87fd11&libraries=services"></script>
			<script>
				// 마커를 담을 배열입니다
				var markers = [];
