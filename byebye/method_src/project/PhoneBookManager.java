...
import bookver4.PhoneCompaanyInfor;
import bookver4.PhoneInfor;
import bookver4.PhoneUnivInfor;
...
public class PhoneBookManager {
	...
	void insertInfor(int select) {
		...
		if (select == 1) {
			...
			pi = new PhoneCompaanyInfor(name, phoneNumber, email, company);
